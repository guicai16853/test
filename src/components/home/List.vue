<template>
	<div class="home-items" >
					<!--循环的列表 begin-->
					<router-link to="/shopHome" class="items" v-for="item in shopInfoList">
...
<script>
	...
	data(){
		return {
			shopInfoList:[
			{ pic:require("../../../static/img/pic4.jpg"),
			  Authentication:'未实名认证',
			  distance:130,
			  industry:'制造行业',
			  scan:330,
			  words:10	
		    },
	   { pic:require("../../../static/img/pic5.jpg"),
			  Authentication:'未实名认证',
			  distance:330,
			  industry:'it行业',
			  scan:630,
		    ...
		    { pic:require("../../../static/img/pic6.jpg"),
			  Authentication:'未实名认证',
			  distance:830,
			  industry:'it行业',
			  scan:430,
...
<style scoped>
 ...
 .home-items .items {
     padding: 0.8rem 0.84rem 0.84rem 0;
     display: flex;
     justify-content: space-between;
     color: #333333;
}

 .home-items .items .items-left {
     display: flex;
     justify-content: space-around;
}
 .home-items .items .items-left img {
     width: 5rem;
     height: 5rem;
     border-radius: 0.3rem;
}
 .home-items .items .items-left .ml10{
 	margin-left: 0.7rem;
 }
  .home-items .items .items-left .ml10 p{
  	margin-top: 0.4rem;
  }
 .home-items .items .items-right {
     display: flex;
     justify-content: space-between;
     flex-direction: column;
}
 .home-items .items .items-right div {
     display: flex;
     justify-content: space-around;
}
 .home-items .items .items-right div p {
     margin-right: 0.4rem;
}	
</style>